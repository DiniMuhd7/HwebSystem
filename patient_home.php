...
<body>
	...
	<input type='hidden' name='submitted' id='submitted' value='1'/>
    	...
    	<div class="ripples buttonRipples"><span class="ripplesCircle"></span></div>
  		...
  		<a class = 'head-title' type='submit' href='./update_patient.php' name='edit' id='edit' class="">EDIT RECORD</a>
  		<br>
  		<a class = 'head-title' type='submit' href='./login.php' name='logout' id='logout' class="">LOGOUT</a>
	</form>
