				...
				<section id="RegSection" class="no-padding-bottom active">
                    ...
                    <div class="group">
                      ...
                      <label>Patient ID</label>
  									...
  									<div class="group">
    									<input id='name' class="form-control" type="text" name='name' value='' length="30" maxlength="50"><span class="highlight"></span>
    									<label>First Name</label>
  									</div>
  									<div class="group">
   										<input id='lastname' type="text" name='lastname' class="form-control" value='' maxlength="30"><span class="highlight"></span>
    									<label>Last Name</label>
  									</div>
  								
  									<div class="group">
   										<input type="email" name='email' id='email' class="form-control" value='' maxlength="50"><span class="highlight"></span>
                			...
                			<div class="group">
   										<input id='address' type="text" name='address' class="form-control" value='' maxlength="30"><span class="highlight"></span>
    									<label>Address</label>
  									</div>

                    <div class = "group">
                      <input type="date" name="birthday" id="birthday"><span class="highlight"></span>
                    ...
                    <button type="submit" id='delete' name='delete' value='delete' class="button buttonBlue">DELETE
                     ...
                     <a class = 'head-title' type='submit' href='./patient_home.php' name='edit' id='edit' class="">BACK TO HOME</a>
...
{ 
  ...
  $mQuery = "SELECT * FROM `patient` WHERE `patient`.`patient_id` = '$patientId';";
  $result = mysqli_query($database, $mQuery) or die("Could not execute sql command.");
  if ($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
  {
    $query = "UPDATE `patient` SET `patient`.`name` = '$patientFname', `patient`.`lastname` = '$patientLname', `patient`.`email` = '$patientEmail', `patient`.`gender` = '$patientGender', `patient`.`address` = '$patientAddress', `patient`.`birthday` = '$patientBirthday' WHERE `patient`.`patient_id` = '$patientId';";
...
if(isset($_POST['delete']))
{
  ...
  if ($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
  {
    $query = "DELETE FROM `patient` WHERE `patient`.`patient_id` = '$patientId';";
